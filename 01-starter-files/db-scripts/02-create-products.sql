...
-- Schema db-vnsapp
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `db-vnsapp`;

CREATE SCHEMA `db-vnsapp`;
USE `db-vnsapp` ;

-- -----------------------------------------------------
-- Table `db-vnsapp`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db-vnsapp`.`product_category` (
...
-- -----------------------------------------------------
-- Table `db-vnsapp`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db-vnsapp`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
